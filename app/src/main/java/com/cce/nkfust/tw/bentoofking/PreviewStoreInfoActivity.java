...
public class PreviewStoreInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_store_info);
        ...
        emailEditText.setText(store.getEmail());
        nameEditText.setText(store.getStoreName());
        addressEditText.setText(store.getAddress());
        phoneEditText.setText(store.getPhone());


        String timetemp = store.BusinessHours;
        char chartime ;
        String intime1="";
        String test1="";
        String intime2="";
    ...
    public class NextHandler implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            progressDialog = ProgressDialog.show(context, "請稍等...", "資料上傳中...", true);
