...
public class MemberAppealActivity extends AppCompatActivity {
    ...
    private MemberAppealAdapter memberAppealAdapter;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS:
                    ...
                    memberAppealAdapter = new MemberAppealAdapter(inflater,appealArrayList);
                    appealListView.setAdapter(memberAppealAdapter);//3.設Adapter
                    appealListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> adapterView, View view, int i,final long l) {
                            Intent intent = new Intent();
                            intent.setClass(context,CheckMemberAppealActivity.class);
                ...
                case REFRESH_ACTIVITY:
                    memberAppealAdapter.notifyDataSetChanged();
                    break;
            }
...
class MemberAppealAdapter extends BaseAdapter { //2.建Adapter
    ...
    public MemberAppealAdapter(LayoutInflater inflater, ArrayList<Appeal> appeal) {
        this.appeal = appeal;
