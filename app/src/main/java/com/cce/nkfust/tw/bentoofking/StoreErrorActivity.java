...
public class StoreErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getResources().getString(R.string.storeError));
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS:
                    ...
                    appealAdapter = new AppealAdapter(inflater,appealArrayList);
...
class AppealAdapter extends BaseAdapter { //2.建Adapter
    ...
    public AppealAdapter(LayoutInflater inflater, ArrayList<Appeal> appeal) {
        this.appeal = appeal;
